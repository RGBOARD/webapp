        ...
        <div className="w-1/4 p-2 flex flex-col items-center h-full">
            {selectedDesign ? (<div
                    ...
                    <div className="flex flex-col w-full max-w-xs space-y-4 mt-4"
                        ...
                        <button
                            onClick={handleQueue}
                            className="w-full border font-bold text-black border-gray-300 bg-yellow-400 py-2 rounded-md text-md font-pixelify hover:bg-white hover:text-yellow-400 hover:shadow-md transition-all duration-200 ease-in-out"
                        >
                            Queue
                        </button>
                        ...
                        <div className="flex gap-4">
                            <button
                                onClick={handleEdit}
                                className="flex-1 border font-bold text-black border-gray-300 bg-blue-500  py-2 rounded-md text-md font-pixelify hover:bg-white hover:text-blue-500 hover:shadow-md transition-all duration-200 ease-in-out"
                            >
                                Edit
                            </button>
                            <button
